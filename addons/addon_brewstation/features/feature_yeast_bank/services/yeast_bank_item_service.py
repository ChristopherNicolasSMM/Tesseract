...
_READONLY = {"id", "created_at", "updated_at", "is_deleted", "deleted_at"} | get_readonly_fields(YeastBankItem)
...
_ATIVO_FIELD_NAME = next(
    (f for f in ("ativo", "is_active") if f in YeastBankItem.__table__.columns.keys()),
    None,
)
