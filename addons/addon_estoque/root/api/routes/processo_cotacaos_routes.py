"""
addons/addon_estoque/root/api/routes/processo_cotacaos_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via processo_cotacaos_routes_hooks.py (nunca sobrescrito).
"""
...
processo_cotacaos_api_bp = Blueprint(
    "processo_cotacaos_api", __name__, url_prefix="/api/estoque/processo-cotacaos"
)
...
@processo_cotacaos_api_bp.route("/", methods=["GET"])
@login_required
...
@processo_cotacaos_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@processo_cotacaos_api_bp.route("/", methods=["POST"])
@login_required
...
@processo_cotacaos_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@processo_cotacaos_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@processo_cotacaos_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@processo_cotacaos_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
