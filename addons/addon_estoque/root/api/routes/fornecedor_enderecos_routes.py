"""
addons/addon_estoque/root/api/routes/fornecedor_enderecos_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via fornecedor_enderecos_routes_hooks.py (nunca sobrescrito).
"""
...
fornecedor_enderecos_api_bp = Blueprint(
    "fornecedor_enderecos_api", __name__, url_prefix="/api/estoque/fornecedor-enderecos"
)
...
@fornecedor_enderecos_api_bp.route("/", methods=["GET"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/", methods=["POST"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@fornecedor_enderecos_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
