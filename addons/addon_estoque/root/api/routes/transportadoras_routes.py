"""
addons/addon_estoque/root/api/routes/transportadoras_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via transportadoras_routes_hooks.py (nunca sobrescrito).
"""
...
transportadoras_api_bp = Blueprint(
    "transportadoras_api", __name__, url_prefix="/api/estoque/transportadoras"
)
...
@transportadoras_api_bp.route("/", methods=["GET"])
@login_required
...
@transportadoras_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@transportadoras_api_bp.route("/", methods=["POST"])
@login_required
...
@transportadoras_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@transportadoras_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@transportadoras_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@transportadoras_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
