"""
addons/addon_estoque/root/api/routes/pedido_compras_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via pedido_compras_routes_hooks.py (nunca sobrescrito).
"""
...
pedido_compras_api_bp = Blueprint(
    "pedido_compras_api", __name__, url_prefix="/api/estoque/pedido-compras"
)
...
@pedido_compras_api_bp.route("/", methods=["GET"])
@login_required
...
@pedido_compras_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@pedido_compras_api_bp.route("/", methods=["POST"])
@login_required
...
@pedido_compras_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@pedido_compras_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@pedido_compras_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@pedido_compras_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
