"""
addons/addon_estoque/root/api/routes/item_pedido_compras_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via item_pedido_compras_routes_hooks.py (nunca sobrescrito).
"""
...
item_pedido_compras_api_bp = Blueprint(
    "item_pedido_compras_api", __name__, url_prefix="/api/estoque/item-pedido-compras"
)
...
@item_pedido_compras_api_bp.route("/", methods=["GET"])
@login_required
...
@item_pedido_compras_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@item_pedido_compras_api_bp.route("/", methods=["POST"])
@login_required
...
@item_pedido_compras_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@item_pedido_compras_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@item_pedido_compras_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@item_pedido_compras_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
