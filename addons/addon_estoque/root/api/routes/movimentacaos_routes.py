"""
addons/addon_estoque/root/api/routes/movimentacaos_routes.py

API JSON — gerado pelo CrudGen. NÃO editar diretamente.
Customizações via movimentacaos_routes_hooks.py (nunca sobrescrito).
"""
...
movimentacaos_api_bp = Blueprint(
    "movimentacaos_api", __name__, url_prefix="/api/estoque/movimentacaos"
)
...
@movimentacaos_api_bp.route("/", methods=["GET"])
@login_required
...
@movimentacaos_api_bp.route("/<int:id>", methods=["GET"])
@login_required
...
@movimentacaos_api_bp.route("/", methods=["POST"])
@login_required
...
@movimentacaos_api_bp.route("/<int:id>", methods=["PUT"])
@login_required
...
@movimentacaos_api_bp.route("/<int:id>/trash", methods=["POST"])
@login_required
...
@movimentacaos_api_bp.route("/<int:id>/restore", methods=["POST"])
@login_required
...
@movimentacaos_api_bp.route("/<int:id>", methods=["DELETE"])
@login_required
