"""
addons/addon_device_manager/root/services/device_metadata_service.py
...
_READONLY = {"id", "created_at", "updated_at", "is_deleted", "deleted_at"} | get_readonly_fields(DeviceMetadata)
...
_ATIVO_FIELD_NAME = next(
    (f for f in ("ativo", "is_active") if f in DeviceMetadata.__table__.columns.keys()),
    None,
)
