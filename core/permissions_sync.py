...
CORE_FIXED_PERMISSIONS = [
    ...
    ("system_config.format_settings", "Editar o padrão global de formatação de moeda/data (achado addon_estoque, sessão pós skill 24)"),
    ("playground_requests.execute", "Executar requisição HTTP ou consulta SQL somente-leitura no Playground"),
]
