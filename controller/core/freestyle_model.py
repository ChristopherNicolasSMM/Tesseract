...
freestyle_bp = Blueprint(
    "freestyle", __name__, url_prefix="/freestyle"
)
...
def home():
    ...
    return render_template("core/freestyle/model_abas.html", page=page)
...
def minimal():
    ...
    return render_template("core/freestyle/model_minimal.html", page=page)
...
def consumption():
    ...
    return render_template("core/freestyle/model_consumption.html", page=page)
...
def full():
    ...
    return render_template("core/freestyle/model_full.html", page=page)
...
#@freestyle_bp.route("/login", methods=["GET"])
#def login_page():
...
def abas():
    ...
    return render_template("core/freestyle/model_abas.html", page=page)#, pages=pages, total=total, per_page=per_page, search=search,)
