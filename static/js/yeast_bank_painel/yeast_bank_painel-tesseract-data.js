 ...
 *
 * Cópia do helper compartilhado de
 * static/js/freestyle/freestyle-tesseract-data.js (skill 18 — o
 * próprio arquivo convida a copiar: "Copie este arquivo para suas
 * telas"). Mantido local à feature pra não depender do namespace de
 * demonstração do freestyle.
 *
...
(function (window) {
  ...
  const TesseractData = {
     ...
     */
    config(id) {
      const bloco = document.getElementById(id || 'painel-config');
      if (!bloco) return {};
      try {
