...
C4Container
    ...
    System_Boundary(tesseract, "Tesseract") {
        ...
        Container(freestyle, "Modelos Freestyle", "Jinja2 + JS por responsabilidade", "Telas de referência vivas para quem escreve página customizada (Fase 13, skill 16)")
    ...
    Rel(freestyle, dataaction, "mesmo endpoint, via helper TesseractData (skill 16)")
...
C4Component
    ...
    Container_Boundary(core, "Core") {
        ...
        Component(freestylectrl, "freestyle_model.py", "Flask", "Modelos de referência vivos — uma função por modelo, sem lógica de negócio (Fase 13, skill 16)")
