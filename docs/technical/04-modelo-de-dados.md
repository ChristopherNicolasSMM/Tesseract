...
| `tesseract_designer_page` | `content_html` (Fase 12) | Renderizado com `\|safe`, **nunca** via `render_template_string()` — Jinja vindo do banco seria SSTI (execução de código no servidor). Dado dinâmico entra só por JavaScript (skill 16) |
